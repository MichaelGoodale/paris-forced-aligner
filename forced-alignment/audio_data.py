...
import re
from typing import Callable, Union, BinaryIO, Optional, Mapping, List, Set
...
class AudioFile:
    ...
    def get_phone_transcription(self):
        raise NotImplementedError("Phone mapping is not implemented in basefile")
...
class LibrispeechFile(AudioFile):
    ...
    def get_phone_transcription(self, transcription: str):
